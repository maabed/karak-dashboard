...
$(function($) {
  ...
  $(document).ready(function() {
    ...
    $('#preview4').click(function() {
      ...
      $('.head-box i').css('color', '#fff');
      $('#company-name').css('color', '#fff');
      $('.sidebar .selected a').css('border-left', '4px solid #2b3643');
    ...
    $('#preview5').click(function() {
      ...
      $('.head-box i').css('color', '#fff');
      $('#company-name').css('color', '#fff');
      $('.sidebar .selected a').css('border-left', '4px solid #262930');
    ...
    $('#preview6').click(function() {
      ...
      $('.search-text-box ').css('background-color', '#828282');
