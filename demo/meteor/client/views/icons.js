Template.icons.onCreated(function iconsOnCreated() {

});

Template.icons.onRendered(function iconsonRendered() {
  $('#table_id').DataTable();
  ...
  var table = $('#detailed_table').DataTable({ // when using let or const instead of var, there's an error on table!
...
Template.icons.helpers(function iconshelpers() {

});

Template.icons.events(function iconsOnCreated() {
