Template.forms.onCreated(function formsOnCreated() {

});

Template.forms.onRendered(function formsOnRendered() {
	...
	function formatState(state) {
		...
		var $state = $(
			'<span><img src="images/' + state.element.value.toLowerCase() + '.png" width="30px" class="img-flag" /> ' + state.text +
			'</span>',
		);
		return $state;
	}
