...
Template.charts.onCreated(function chartsOnCreated() {

});

Template.charts.onRendered(function chartsonRendered() {
  /* High charts*/
  ...
  /* Line chart*/
  const ctx4 = document.getElementById('line');
  ...
  /* polar chart */
  const ctxp = document.getElementById('polar');
  const datap = {
    datasets: [{
      data: [
        7,
...
Template.charts.helpers(function chartshelpers() {

});

Template.charts.events(function chartsOnCreated() {
