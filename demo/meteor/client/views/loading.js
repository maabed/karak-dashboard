Template.loading.onRendered(function() {
  ...
  const basicinit = new ProgressBar.Circle(init, {
    strokeWidth: 6,
    easing: 'easeInOut',
    duration: 1400,
    color: '#67b2e4',
...
Template.loading.events({
  'click #circleGenerate' (event, instance) {
    ...
    /* bounce circle */
      ...
      const bounceC = new ProgressBar.Circle(bounce, {
        color: '#FFEA82',
        trailColor: '#eee',
        trailWidth: 1,
        duration: 1400,
    ...
    /* multi circle */
      ...
      const multiC = new ProgressBar.Circle(multi, {
        color: '#aaa',
        strokeWidth: 4,
        trailWidth: 1,
        easing: 'easeInOut',
    ...
    /*Semi circle*/
      ...
      const bar = new ProgressBar.SemiCircle(semi, {
        strokeWidth: 6,
        easing: 'easeInOut',
        duration: 1400,
        color: Color,
      ...
      const bar = new ProgressBar.SemiCircle(txt, {
        strokeWidth: 6,
        color: '#FFEA82',
        trailColor: '#eee',
        trailWidth: 1,
